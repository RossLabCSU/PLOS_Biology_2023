...
def plot_year_lineplot(df, years, journals, journal_labels, fig_panel, fig_height):
    ...
    plt.ylabel('Median Percentage of Self-\nReferences Per Publication', fontname='Arial', fontsize=14)
...
def get_centraltendencies():
    ...
    h = open('SelfReferencing_DistributionStatistics_AllJournals_Fig1.tsv')
    header = h.readline()
    for line in h:
